import type { MessageBoxOptions, MessageBoxData, MessageBoxCallback, MessageBoxAction, MessageBoxProps, IWMessageBox } from './types'
...
export default MessageBox as IWMessageBox